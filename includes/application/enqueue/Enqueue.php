<?php
	...
	class WSL_EnqueueBuilder {

		function __construct() {
			$this->enqueue = new WSL_Enqueue();
		}
	...
	require_once( WSL_ACHIEVEMENTS_PATH_ENQUEUE . 'EnqueueVars.php' );
	require_once( WSL_ACHIEVEMENTS_PATH_ENQUEUE . 'styles.php' );
	require_once( WSL_ACHIEVEMENTS_PATH_ENQUEUE . 'scripts.php' );